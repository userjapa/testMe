...
const rand = (el) => {
    switch(el.type) {
        ...
        case 'text': return randStr(25); break;
        case 'date': return randDate(0); break;
        case 'time': return randDate(1); break;
        case 'email': return randStr(15)+"@testme.com"; break;
...
let rand = __webpack_require__(1);
...
let serviceInput = __webpack_require__(4),
    serviceSelect = __webpack_require__(5),
